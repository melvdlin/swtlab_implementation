...
class CustomerAccountAdapterTest {
    ...
    @Test
    void testGetCustomerAccountNonExisting() {
        try {
            Optional<CustomerAccount> ca = customerAccountAdapter.getCustomerAccount("abcd");
            assertNotEquals(null, ca);
    ...
    void testAddCustomerAccount() {
        ...
        try {
            customerAccountAdapter.addCustomerAccount(newAccountEmail, newAccountPassword);
            Optional<CustomerAccount> ca = customerAccountAdapter.getCustomerAccount(newAccountEmail);
            assertTrue(ca.isPresent());
            assertEquals(newAccountEmail, ca.get().email());
            assertEquals(newAccountPassword, ca.get().password());
        } catch (SQLException e) {
            fail();
        }
    }
